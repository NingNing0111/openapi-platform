...
import me.pgthinker.web.mapper.UserMapper;
...
import me.pgthinker.utils.SqlUtils;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public void initAdminUser(){
        ...
        User one = this.getOne(wp);
        if(ObjectUtils.isEmpty(one)){

            String encryptPassword = DigestUtils.md5DigestAsHex((SALT + "123123123").getBytes());
            User urr = new User();
            urr.setUserAccount("admin");
            urr.setUserPassword(encryptPassword);
            urr.setEmail("zdncode@gmail.com");
            urr.setAccessKey(GenKeyUtils.genKey(16));
            urr.setSecretKey(GenKeyUtils.genKey(32));
            urr.setUserName("admin");
            urr.setUserRole(UserRoleEnum.ADMIN.getValue());
            this.save(urr);
        }
    }
